...
const BirthdayPreview2 = ({ image, canvas, name, drname, MRID }) => {
  const customstyles = {
    // backgroundColor: "red",
      ...
      >
        {
          <>
            {canvas && (
              <div className="sm:w-[300px] w-[150px] relative">
                <img
                  ...
                  style={{}}
                />
                <div className="md:w-[500px] relative md:left-[-90px] left-[-77px] w-[300px] ">
                  <h1 className="relative font-bold uppercase md:text-4xl text-2xl text-center mt-[30px] text-black">
                    {drname}
                  </h1>
                </div>
              </div>
...
export default BirthdayPreview2;
