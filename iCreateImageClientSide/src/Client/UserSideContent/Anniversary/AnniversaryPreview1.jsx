...
const AnniversaryPreview1 = ({ image, canvas, name, drName, MRID }) => {
  const customstyles = {
    // backgroundColor: "red",
    ...
    <>
      <div className="md:w-[794px] sm:h-[1123px]  h-[763px] m-auto">
        ...
        >
            ...
            {canvas && (
              <div className="md:w-[450px] w-[200px] relative top-[-70px] md:top-[-161px]">
                <img
...
<div className="md:w-[500px] relative left-[-8px] md:top-[-53px] top-[-23px]">
                 <h1
              className="relative font-bold uppercase md:text-4xl text-xl  text-center mt-[30px] text-black"
...
export default AnniversaryPreview1;
