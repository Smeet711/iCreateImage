...
import "../../Login.css";
import AnniversaryPreview1 from "./AnniversaryPreview1";
    ...
    <>
      {isSubmitVisible && (
        <div className="container mx-auto p-8  rounded-lg">
          ...
          <p>Please fill the form to design your Anniversary Card.</p>
          </div>
...
export default AnniversaryForm1;
