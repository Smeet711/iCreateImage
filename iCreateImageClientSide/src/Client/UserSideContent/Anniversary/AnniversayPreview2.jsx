...
const AnniversayPreview2 = ({ image, canvas, name, drName, MRID }) => {
  const customstyles = {
    // backgroundColor: "red",
  ...
  //   handleUserData();
  //   // alert("Layout under Development");
  //   if (input) {
  //     domtoimage
  //       .toPng(input)
  //       .then((dataUrl) => {
  ...
  return (
    <>
      <div className="md:w-[794px] sm:h-[1123px]  h-[763px] m-auto">
        ...
        <div
          id="divToPrint"
          className="flex justify-center items-center flex-col md:w-full md:h-full w-auto h-[70%]"
          style={customstyles}
        >
          {canvas && (
            <div className="md:w-[370px] w-[163px] relative top-[-22px] md:top-[-70px] md:left-[10px]">
              <img
          ...
          <div className="md:w-[500px] relative left-[-8px] md:top-[-31px] top-[-23px]">
            <h1 className="relative font-bold uppercase md:text-4xl text-xl  text-center mt-[30px] text-black">
              {drName}
            </h1>
          </div>
        </div>
...
export default AnniversayPreview2;
