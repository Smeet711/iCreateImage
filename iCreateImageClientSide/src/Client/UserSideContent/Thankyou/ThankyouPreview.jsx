    ...
    <>
      <div className="md:w-[794px] sm:h-[1123px]  h-[763px] m-auto">
        ...
        <div
          ...
          style={customstyles}
        >
          <h1 className="text-center text-2xl font-semibold  uppercase relative sm:text-4xl sm:top-[-140px] top-[-75px] ">
            {drname}
          </h1>

          <div className="w-[300px]  relative flex justify-center items-center flex-col">
