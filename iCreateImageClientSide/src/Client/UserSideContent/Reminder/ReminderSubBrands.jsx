...
const ReminderSubBrands = () => {
  ...
  function sendtoform(image, brandname, name) {
    ...
    if (brandName === "Sun Pharma") {
      navigate(`/client/reminderform/${MRID}/${id}/${image}/${brandName}`);
    } else {
      navigate(`/client/reminderform2/${MRID}/${id}/${image}/${brandName}`);
    }
  }
...
<div className="container mx-auto p-8  rounded-lg">
      ...
      <div className="flex flex-row justify-between items-center relative top-[-24px]">
            <NavLink className="p-5 flex relative left-[-36px] " to={`/client/clientreminder/${MRID}`}>
              <div
...
export default ReminderSubBrands;
