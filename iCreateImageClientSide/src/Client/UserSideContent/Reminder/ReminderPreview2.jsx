...
function ReminderPreview2({
  ...
  //   handleDataSubmit();
  //   alert("Layout 2 Under Devolopment for Reminder");
  //   if (input) {
  //     domtoimage
  //       .toPng(input)
  //       .then((dataUrl) => {
        ...
        >
          {
            <>
              ...
              <h1 className="text-center   md:font-bold font-bold relative  md:text-4xl md:top-[-44px]   text-xl md:left-[-30px] left-[26px] top-[108px]  ">
                {drname}
              </h1>
...
export default ReminderPreview2;
