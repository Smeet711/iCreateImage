...
import PosterPreview2 from "./PosterPreview2";
import { RxCross1 } from "react-icons/rx";
import { useNavigate, useParams,NavLink } from "react-router-dom";
import "./poster.css";
import PosterPreview3 from "./PosterPreview3";
import '../../Login.css'
...
const Form3 = () => {
  ...
  const backtotempl = () => {
    navigate(`/client/clientposter/${MRID}`); // replace 'username' with the actual username
  };
  return (
    <>
      {isSubmitVisible && (
        ...
        <div className="flex flex-row justify-between items-center relative top-[-36px] left-[-24px]">
          ...
          <p>Please fill the form to design  your poster.</p>
            ...
            <div className=" flex justify-center py-6 w-[100%]">
              <input
                className="w-[103%] h-[40px] px-4 py-2 rounded-full border  focus:outline-none focus:border-blue-500 transition duration-300"
                type="text"
