...
const CertificatePreview2 = ({ image, drname, name, MRID }) => {
  ...
  //   handleSubmit();
  //   // alert("Layout 2 for Certifiate under Development");
  //   if (input) {
  //     domtoimage
  //       .toPng(input)
  //       .then((dataUrl) => {
  ...
  return (
    <div className="md:w-[794px] sm:h-[1123px]  h-[763px] m-auto">
      ...
      >
        <h1
          className="text-center text-2xl relative md:top-[80px] top-[37px] font-bold"
