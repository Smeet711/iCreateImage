...
const AnniversaryBrandEdits = () => {
  ...
  const submit = async (e) => {
    ...
    const response = await axios.put(
      `https://icreate-admin-backend.onrender.com/anniversary-sub-brand/${id}`,
      formData,
      {
        headers: {
...
export default AnniversaryBrandEdits;
